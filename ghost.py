...
#                            Name = summon(op.param2)
	    ...
	    if mid in op.param3:
			...
			nadya.updateGroup(G)
			Ti = nadya.reissueGroupTicket(op.param1)
			ki.acceptGroupInvitationByTicket(op.param1,Ti)
			kk.acceptGroupInvitationByTicket(op.param1,Ti)
            G.preventJoinByTicket = True
			nadya.updateGroup(G)
			nadya.sendText(op.param1,"Hallo Kak Trimakasih Sudah Invite Saya Di Grup Ini...\nSalam Kenal Buat Para Pasukan Fams\n 👇🏻👇🏻👇🏻\n" + str(ginfo.name) + "Udah Gitu Aja Kak TQ..\n\nʙʏ: ᴀᴠʀɪʟɪᴀ")
	    else:
		...
		if wait["AutoKick"] == True:
			...
			random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
			    ...
			    if op.param2 in Bots:
                    ...
                    nadya.acceptGroupInvitationByTicket(op.param1,Ti)
                    ki.acceptGroupInvitationByTicket(op.param1,Ti)
                    kk.acceptGroupInvitationByTicket(op.param1,Ti)
        ...
        if op.type == 15:
          if wait["Sambutan"] == True:
            if op.param2 in Creator:
                return
            nadya.sendText(op.param1,"Nahhhh Lohhhhh Koq Left Sihh..." + nadya.getContact(op.param2).displayName +  "\nGak Asik Ahh...")
            d = Message(to=op.param1, from_=None, text=None, contentType=7)
            d.contentMetadata={
                                    "STKID": "13269542",
                                    "STKPKGID": "1329191",
	 ...
	 if wait["Ghost"] == True:
		...
		nadya.sendText(msg.to,"❂••••••=═ই✪͜͡✪۝✪͜͡✪ई═=•••••❂")
		ki.sendText(msg.to,"Itu Creator Kami,Kereen Kan...wkwk")
		...
		print wait["AutoCancel"]
	     ...
	     if msg.from_ in admin:	        
                ...
                ki.sendText(msg.to,"invite Protect Sudah Aktif")
                kk.sendText(msg.to,"invite Protect Sudah Aktif")
		print wait["inviteprotect"]
	     ...
	     if msg.from_ in admin:	        
                ...
                ki.sendText(msg.to,"Invite Protect Sudah Di Nonaktifkan")
                kk.sendText(msg.to,"Invite Protect Sudah Di Nonaktifkan")
		print wait["inviteprotect"]
	     else:
		    nadya.sendText(msg.to,"Khusus Nadya")		    
	     ...
	     if msg.from_ in admin:	        
	        ...
	        ki.sendText(msg.to,"QR Protect Sudah Aktif")
	        kk.sendText(msg.to,"QR Protect Sudah Aktif")
	     else:
		    nadya.sendText(msg.to,"Khusus Nadya")	    	
	     ...
	     if msg.from_ in admin:	        
	        ...
	        ki.sendText(msg.to,"Qr Protect Sudah Di Nonaktifkan")
	        kk.sendText(msg.to,"Qr Protect Sudah Di Nonaktifkan")
	     else:
		    nadya.sendText(msg.to,"Khusus Nadya")	    	
	     ...
	     if msg.from_ in admin:	 	        
		     ...
		     ki.sendText(msg.to,"Auto Kick Sudah Aktif")
		     kk.sendText(msg.to,"Auto Kick Sudah Aktif")
	     else:
	        nadya.sendText(msg.to,"Khusus Nadya")	     
	     ...
	     if msg.from_ in admin:	 	        
		     ...
		     ki.sendText(msg.to,"Auto Kick Sudah Di Nonaktifkan")
		     kk.sendText(msg.to,"Auto Kick Sudah Di Nonaktifkan")
	     else:
	        nadya.sendText(msg.to,"Khusus Nadya")
		...
		if msg.from_ in admin:
                    ...
                    ki.sendText(msg.to,"All Protect Sudah Aktif Semua")
                    kk.sendText(msg.to,"All Protect Sudah Aktif Semua")
		else:
		    nadya.sendText(msg.to,"Khusus Nadya")
		...
		if msg.from_ in admin:
                    ...
                    ki.sendText(msg.to,"All Protect Sudah Di Nonaktifkan Semua")
                    kk.sendText(msg.to,"All Protect Sudah Di Nonaktifkan Semua")
		else:
		    nadya.sendText(msg.to,"Khusus Nadya")
...
#-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
		        ...
		        nadya.sendText(msg.to,"Pasukan Kicker!!")
                ki.sendText(msg.to,"Kicker 1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"Kicker 2 Hadiir  \(ˆ▿ˆ)/")
                ...
                start = time.time()
                nadya.sendText(msg.to, "「Progress Speeds...」")
                elapsed_time = time.time() - start
                nadya.sendText(msg.to, "%sseconds" % (elapsed_time))                
                            ...
                            nadya.sendMessage(to, "ini id Smulenya Boss Quh \n" + smule)
                        ...
                        for target in targets:
                          if not target in Bots:
                            try:
                                ...
                                nadya.sendText(msg,to,"Group Cleanse")
...
#==============================================
            ...
            elif msg.text.lower() in ["hy","Sayang","halo","hallo"]:
                    beb = "Hay Sayang 😘 Miss You Aja Dehh... " +nadya.getContact(msg.from_).displayName + " 􀸂􀆇starry heart􏿿"
